...
# i18n
gettext.install("xentadesktop", "/usr/share/xentaos/locale")
...
class XentaDesktop:
    ...
    def help_button_clicked(self, widget):
        Popen(["xdg-open", "help:xentadesktop"])
    ...
    def __init__(self):
        ...
        self.builder.add_from_file('/usr/share/xentaos/xentadesktop/main.ui')
        ...
        if source.lookup('org.mate.session.required-components', True):
            ...
            settings.set_string("windowmanager", "xenta-window-manager")
        ...
        os.system('cp /usr/share/xentaos/xentadesktop/xfce-autostart-wm.desktop ~/.config/autostart/')
        ...
        # terminal page
        self.init_checkbox("com.xentaos.terminal", "show-fortunes", "checkbox_fortunes")
        ...
        if "XDG_CURRENT_DESKTOP" in os.environ:
            ...
            self.init_combobox("com.xentaos.desktop", wm_key, "combo_wm")
